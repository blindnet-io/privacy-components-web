...
import { Recommendation, ComputationAPI } from '@blindnet/core';
...
let BldnBridgeDemandListItem = class BldnBridgeDemandListItem extends LitElement {
    constructor() {
        super(...arguments);
        this._open = false;
...
BldnBridgeDemandListItem.styles = [
    bldnStyles,
    css `
      :host textarea {
        font-family: var(
...
], BldnBridgeDemandListItem.prototype, "demand", void 0);
__decorate([
    state()
], BldnBridgeDemandListItem.prototype, "_demandDetails", void 0);
__decorate([
    state()
], BldnBridgeDemandListItem.prototype, "_open", void 0);
__decorate([
    state()
], BldnBridgeDemandListItem.prototype, "_dropdownUiState", void 0);
__decorate([
    state()
], BldnBridgeDemandListItem.prototype, "_selectedResponseType", void 0);
__decorate([
    state()
], BldnBridgeDemandListItem.prototype, "_message", void 0);
BldnBridgeDemandListItem = __decorate([
    customElement('bldn-bridge-demand-list-item')
], BldnBridgeDemandListItem);

export { BldnBridgeDemandListItem };
//# sourceMappingURL=bldn-bridge-demand-list-item.js.map
