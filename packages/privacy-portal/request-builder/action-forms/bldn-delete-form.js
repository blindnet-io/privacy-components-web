 ...
 */
let BldnDeleteForm = class BldnDeleteForm extends ActionForm {
    constructor() {
        super(...arguments);
        /** @prop */
        this.dataCategories = [];
        this.action = PrivacyRequestDemand.action.DELETE;
    }
    validateActionInput() {
        return undefined;
    }
...
], BldnDeleteForm.prototype, "dataCategories", void 0);
BldnDeleteForm = __decorate([
    customElement('bldn-delete-form')
], BldnDeleteForm);

export { BldnDeleteForm };
//# sourceMappingURL=bldn-delete-form.js.map
