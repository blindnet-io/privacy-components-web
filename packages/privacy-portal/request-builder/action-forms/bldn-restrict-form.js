 ...
 */
let BldnRestrictForm = class BldnRestrictForm extends ActionForm {
    constructor() {
        super(...arguments);
        ...
        this.purposes = [];
        this.action = PrivacyRequestDemand.action.RESTRICT;
    }
    validateActionInput() {
        return undefined;
    }
...
BldnRestrictForm.styles = [ActionForm.styles, css ``];
__decorate([
    property({ type: Array, attribute: 'data-categories' })
], BldnRestrictForm.prototype, "dataCategories", void 0);
__decorate([
    property({ type: Array, attribute: 'processing-categories' })
], BldnRestrictForm.prototype, "processingCategories", void 0);
__decorate([
    property({ type: Array, attribute: 'purposes' })
], BldnRestrictForm.prototype, "purposes", void 0);
BldnRestrictForm = __decorate([
    customElement('bldn-restrict-form')
], BldnRestrictForm);

export { BldnRestrictForm };
//# sourceMappingURL=bldn-restrict-form.js.map
