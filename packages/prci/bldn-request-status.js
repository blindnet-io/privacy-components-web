...
const cancelSvg = new URL(new URL('assets/ic_round-cancel.svg', import.meta.url).href, import.meta.url)
    .href;
        ...
        ${when(this._requestDetails.length > 0, () => html `
            ...
            return html `
                <bldn-dropdown>
                  <span slot="heading"
                    ><strong
                      >${msg(html `${ACTION_TITLES[demand.requested_action]()} Demand`)}&nbsp;&nbsp;&nbsp;<span class=${classMap(classes)}
