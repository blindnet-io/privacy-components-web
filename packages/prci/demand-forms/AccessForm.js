...
import { PROCESSING_CATEGORY, PURPOSE, ACTION, PROVENANCE, TARGET } from '../models/priv-terms.js';
 ...
 */
let AccessForm = class AccessForm extends DemandForm {
    constructor() {
        super();
...
], AccessForm.prototype, "allowedDataCategories", void 0);
AccessForm = __decorate([
    customElement('access-form')
], AccessForm);

export { AccessForm };
//# sourceMappingURL=AccessForm.js.map
