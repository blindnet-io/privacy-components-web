...
export function GeneralInformationFromJSONTyped(
  ...
  return {
    ...
    dpo: json['dpo'],
    data_consumer_categories: !exists(json, 'data_consumer_categories')
      ? undefined
      : json['data_consumer_categories'],
    privacy_policy_link: !exists(json, 'privacy_policy_link')
      ? undefined
      : json['privacy_policy_link'],
    data_security_info: !exists(json, 'data_security_info')
      ? undefined
...
export function GeneralInformationToJSON(
  ...
  return {
    ...
    dpo: value.dpo,
    data_consumer_categories: value.data_consumer_categories,
    privacy_policy_link: value.privacy_policy_link,
    data_security_info: value.data_security_info,
  };
}
