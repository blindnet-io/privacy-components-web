    ...
    return html`
      <bx-header aria-label="blindnet devkit simple tutorial">
        ...
        <bx-header-nav menu-bar-label="blindnet devkit tutorial">
          <bx-header-nav-item href="./participate">Submit an entry</bx-header-nav-item>
          <bx-header-nav-item href="./privacy">Submit a privacy request</bx-header-nav-item>
          <bx-header-nav-item href="./backoffice">Back office management</bx-header-nav-item
          >
        </bx-header-nav>
      </bx-header>
      <bx-side-nav aria-label="Side navigation">
        <bx-side-nav-items>
          ...
          <bx-side-nav-link href="./participate">Submit an entry</bx-side-nav-link>
          <bx-side-nav-link href="./privacy">Submit a privacy request</bx-side-nav-link>
          <bx-side-nav-link href="./backoffice">Back office management</bx-side-nav-link>
        </bx-side-nav-items>
      </bx-side-nav>
      <main>
